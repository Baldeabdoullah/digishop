...
<head>
    ...
    <title>Vente de téléphones Huawei en ligne à Dakar Digishop</title>
    <meta name="description" content="Trouver une boutique en ligne à Dakar? Huawei en vente à Dakar. Visitez Digishop boutique en ligne au Sénégal Achat de téléphone portable au sénégal">
...
<body>
    ...
    <div class="container d-flex px-4">
        <div class="d-none d-lg-block px-5">
            ...
            <div class=" mt-3 mb-4 button-group  ">
                ...
                <div class=" row d-inline-block justify-content-start ">
                    ...
                    <button type="button" id="telephone" class="btn btn-primary filtre-bouttons  text-dark">Telephone</button>
                    <button type="button" id="montre" class="btn btn-primary filtre-bouttons  text-dark">Montre Connectée</button>
                    <button type="button" id="ordinateur" class="btn btn-primary filtre-bouttons  text-dark">Ordinateur </button>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            $sql = "Select * from `produits` where marques = 'huawei'  ";
            ...
            if ($result) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo ' <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 filtre-element tout  ' . $cathegorie . '">
                <div class="smartphone_container">
                    <a href="detail.php?details_id=' . $id . '" class="text-center  text-decoration-none">
                        <img src=' . $image1 . ' alt= "' . $marques . '  ' . $nom . '   en vente à Dakar " class="img-fluid">
