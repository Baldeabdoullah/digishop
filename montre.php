...
<head>
    ...
    <title>Vente de montres connectées à Dakar Digishop</title>
    <meta name="description" content="Trouver une boutique en ligne à Dakar? montres connectées en vente à Dakar. Visitez Digishop boutique en ligne au Sénégal Achat de téléphone portable au sénégal">
...
<body>
    ...
    <div class="container d-flex px-4">
        ...
        <div class="row">
            ...
            $sql = "Select * from `produits` where cathegorie = 'montre'  ";
            ...
            if ($result) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo ' <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12  filtre-element tout ' . $marques . '">
