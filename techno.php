...
<head>
    ...
    <title>Vente de smartphones en ligne à Dakar Digishop</title>
    <meta name="description" content="Trouver une boutique en ligne à Dakar? Téléphone en vente à Dakar. Visitez Digishop boutique en ligne au Sénégal Achat de téléphone portable au sénégal">
...
<body>
    ...
    <div class="container d-flex px-4">
        <div class="d-none d-lg-block px-5">
            ...
            <div class=" mt-3 mb-4 button-group filter-button-group ">
                ...
                <div class=" row d-inline-block justify-content-start ">
                    <button type="button" data-filter="*" class="btn btn-primary  text-dark">Smartphone</button>
                    <button type="button" data-filter=".electronic" class="btn btn-primary  text-dark">Montre Connectées</button>
                    <button type="button" data-filter=".clothing" class="btn btn-primary  text-dark">PC </button>
        ...
        <div class="row">
            ...
            $sql = "Select * from `produits` where marques = 'techno'  ";
