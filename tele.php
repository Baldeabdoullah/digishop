...
<head>
    ...
    <title>Vente de Télévision en ligne à Dakar Digishop</title>
    <meta name="description" content="Trouver une boutique en ligne à Dakar? smart TV en vente à Dakar. Visitez Digishop boutique en ligne au Sénégal Achat de téléphone portable au sénégal">
...
<body>
    ...
    <div class="container d-flex px-4">
        ...
        <div class="row">
            ...
            $sql = "Select * from `produits` where cathegorie = 'tv'  ";
